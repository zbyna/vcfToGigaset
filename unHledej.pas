...
begin
      ...
      Form1.rxDBGrid1.SelectedRows.CurrentRowSelected:=False;// zrušit výběr
      Form1.ZQuery1.Next;
          ...
          for i:=0 to Form1.Zquery1.FieldCount-1  do
             if Pos((LabeledEdit1.Text), Form1.Zquery1.Fields[i].AsString )>0 then
                begin
                  ...
                  Form1.rxDBGrid1.SelectedRows.CurrentRowSelected:=True;
                  //Form1.rxDBGrid1.SelectedRows.Refresh;
                  goto endOuterLoop; // ukončit vnější cyklus
                end;
             Form1.ZQuery1.Next;
        end;
      Form1.ZQuery1.Bookmark := BookmarkPos; // při nenalezení skočit na původní pozici
      Form1.rxDBGrid1.SelectedRows.CurrentRowSelected:=True;  // a přidat do výběru
      endOuterLoop:
...
begin
      ...
      Form1.rxDBGrid1.SelectedRows.CurrentRowSelected:=True; // přidat do výběru
      endOuterLoop:
      Form1.ZQuery1.EnableControls;
end;
